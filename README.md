...
- 成績項目のクリックまたはスマホの並び替え選択で、各指標の良い順にソート
...
- ダッシュボード表示を `features/mlb-dashboard` 配下の domain/application/infrastructure/ui に分割
...
- 選手追加・絞り込み・並び替え
- 管理画面の設計
- API Route側のMLB Stats更新処理もfeature配下へ整理
